...
def process_polygon(task):
  ...
  try:
    ...
    # Calculate distance on the whole bounding box first, then mask to valid area
    ...
    # ==============================================================
    exhaust_gap_arrays = []
    # Only measure gaps within the masked area to avoid edge inflation
    ...
    all_nri_transects, all_fetch_50cm, all_fetch_100cm = [], [], []
    spoke_bgr_pixels, spoke_bgr_pixels_50cm, spoke_bgr_pixels_100cm = 0, 0, 0
    ...
    total_pins_50cm, total_pins_100cm = 0, 0
    ...
    f50_valid, f100_valid = np.array(all_fetch_50cm), np.array(all_fetch_100cm)
  ...
  for current_fc, csv_name in feature_classes_to_process.items():
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
      for count, result in enumerate(executor.map(process_polygon, tasks), 1):
        ...
        # Now it will print progress fast without slowing you down
