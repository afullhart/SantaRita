...
makeScatterChart(export_csv, 'True_Herb_pct', 'Predicted_Herb_pct', 'Herbaceous Cover (%)', '#91cf60'); 
makeScatterChart(export_csv, 'True_Woody_pct', 'Predicted_Woody_pct', 'Woody Cover (%)', '#8c510a'); 
